...
/*
INSERT INTO order_detail (order_detail_id, employee_id, product_id, cust_id, quantity, unit_price, discount) 
SELECT 'x0000003', '00000001', '00000904', '00004002', 41, p.unit_price, 0
FROM product AS p 
WHERE p.product_id = '00000904';
INSERT INTO order_detail (order_detail_id, employee_id, product_id, cust_id, quantity, unit_price, discount) 
SELECT 'x0000003', '00000001', '00000904', '00004002', 41, p.unit_price, 0
...
/*
INSERT INTO order_detail (order_detail_id, employee_id, product_id, cust_id,quantity, unit_price, discount) VALUES 
('x0000005', '00000001', '00000905', '00004002', 41, 123.99, 0.05); 

CALL process_payment ('x0000005', 'CASH', '1234', '2026', 'Yeo1', 'AIR1', 'WHERE1');
#decimal tested to work with rounding half up
*/

#UPDATE supplier_order SET delivered = 1 WHERE supp_order_id  = 4; # to test task 4 and simulate arrival of goods
