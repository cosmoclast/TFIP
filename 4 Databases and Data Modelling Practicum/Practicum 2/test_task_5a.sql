...
should have 6 orders, with the last 5 orders for 00000904, 
and the orders with more than QTY 40 have 5% discount
...
There should be 5 payments (1 payment is initially already in the table, and 4 payments just made) and 4 shipping orders placed

8. CHECK TABLE - supplier order
The third order should be for 00000904, undelivered after 00000904 QTY dropped to 10
There should not be a fourth order
...
/* Place order for QTY 5 of 00000904 and 
should not have 5% discount*/
INSERT INTO order_detail (order_detail_id, employee_id, product_id, cust_id,
quantity, unit_price)
SELECT 'x0000005', '00000001', '00000904', '00004002', 5, p.unit_price
FROM product AS p
WHERE p.product_id = '00000904';
...
INSERT INTO order_detail (order_detail_id, employee_id, product_id, cust_id,
quantity, unit_price)
SELECT 'x0000006', '00000001', '00000904', '00004002', 60, p.unit_price
FROM product AS p
WHERE p.product_id = '00000904';
...
/* 7. CHECK TABLE - payment NATURAL JOIN shipping_order
There should be 5 payments and 4 shipping orders placed*/
SELECT * FROM payment NATURAL JOIN shipping_order;
/* 8. CHECK TABLE - supplier order
The third order should be for 00000904, undelivered
There should not be a fourth supplier order*/
SELECT * FROM supplier_order;
...
/*ERROR: Pay for the third order of QTY 60 of 00000904
This is just to crash the code since remaining stock is QTY 50*/
CALL process_payment ("x0000006","CREDIT CARD","12345","05/02/2025","TestTest","NINJAVAN","TPY");
