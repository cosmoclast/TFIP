 ...
 * @author Bernard Yeo
 */
public class BukitTimahBranch extends Branch {

    /**
     * String for the branch name
     */
    public static final String BRANCH = "Bukit Timah";
    ...
    public Loan createLoan(String type, double principle, double downPayment, int mths) {
        ...
        if(inputChecker(principle, downPayment, mths)){
            if (typeFormatted.equals("student") ) {
                return new StudentLoan(principle, downPayment, mths, 5, BRANCH);
            } else if (typeFormatted.equals("home")) {
                return new HomeLoan(principle, downPayment, mths, 10, BRANCH);
            }else if (typeFormatted.equals("car")) {
                return new CarLoan(principle, downPayment, mths, 15, BRANCH);
            } else {
                return null;
            }
        } else {
