...
// let numBtns = document.body.querySelectorAll("button:not([class])");
...
// let m1AddBtn = document.body.querySelector("#m1add");
// let m1Btn = document.body.querySelector("#m1");
// let m2AddBtn = document.body.querySelector("#m2add");
// let m2Btn = document.body.querySelector("#m2");
